...
class DataFetcher:
    ...
    def fetch_stock_data(_self, symbols: str or List[str], period: str = "1y", interval: str = "1d") -> pd.DataFrame:
        """
    ...
    @st.cache_data(ttl=300)
    def fetch_multiple_stocks(_self, symbols: List[str], period: str = "1y") -> Dict[str, pd.DataFrame]:
        """
    ...
    @st.cache_data(ttl=300)
    def get_returns_matrix(_self, symbols: List[str], period: str = "1y") -> pd.DataFrame:
        """
