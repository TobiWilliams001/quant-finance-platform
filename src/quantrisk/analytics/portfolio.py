...
class PortfolioOptimizer:
    ...
    def correlation_heatmap(self) -> go.Figure:
        ...
        fig.update_layout(
            title="Asset Correlation Matrix", xaxis_title="Assets", yaxis_title="Assets"
        )

        return fig

    def portfolio_composition_pie(
        self, weights: np.array, labels: List[str]
    ) -> go.Figure:
        """
        ...
        fig.update_layout(title="Portfolio Composition", showlegend=True)
